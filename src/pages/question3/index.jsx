...
const Question3Page = () => {
  ...
  const onClickYes = () => {
    const maxIndex = Object.values(queryYes).indexOf(Math.max(...Object.values(queryYes))) + 2;
  ...
  const onClickNo = () => {
    const maxIndex = Object.values(queryNo).indexOf(Math.max(...Object.values(queryNo)) + 2);
    const query = "shrine" + String(maxIndex);
    console.log(query);
    setTimeout(() => {}, "2500");
    const eachPath = paths.diagnosis + "/" + query;
